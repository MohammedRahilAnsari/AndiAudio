...
import com.musichackspace.thinkific.andiaudio.databinding.ActivityMainBinding
...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.playSwitch.setOnCheckedChangeListener { _, state ->
            setPlayValue(state)
